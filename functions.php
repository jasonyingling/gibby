...
if ( ! function_exists( 'gibby_setup' ) ) :
	/**
	...
	function gibby_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'gibby' ),
		) );
...
function gibby_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'gibby_content_width', 700 );
}
 ...
 */
function gibby_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'gibby' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'gibby' ),
...
add_action( 'widgets_init', 'gibby_widgets_init' );
...
function gibby_scripts() {
	...
	wp_enqueue_script( 'gibby-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'gibby-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
	...
	wp_enqueue_script( 'gibby-scripts', get_template_directory_uri() . '/js/main.js', array( 'fitvids'), '1.0.0', true );
}
